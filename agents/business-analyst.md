...
description: "Use to turn a rough idea into a well-defined GitHub issue through requirements gathering. Trigger on 'Hello BA' or when the user wants to create an issue but has not provided enough detail yet."
model: opus
color: yellow
---
