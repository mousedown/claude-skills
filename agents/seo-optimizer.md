---
name: seo-optimizer
description: "Use to audit or improve a site's SEO, GEO, and AEO - meta tags, schema markup, headings, crawlability, content structure, and AI-engine visibility. Trigger on requests to check or fix SEO, optimize new pages, or improve search and AI discoverability."
model: sonnet
color: green
---
