#!/bin/zsh
# cost-tracker-statusline — Neon Terminal theme (high contrast, retro hacker aesthetic)
# Self-contained single file — no external dependencies beyond jq, bc, git
# 256-color: 46=neon green, 208=orange, 51=electric cyan, 201=hot pink, 226=neon yellow
...
# Context warning + color — neon to hot warnings
CTX_WARN=""
...
echo -e "${CTX_COLOR}${MODEL} ${BAR} ${USED}%${RST}${CTX_WARN}  \033[1;38;5;208m\$${SESSION_COST_FMT}${RST} \033[38;5;240m(\$${TOTAL_COST_FMT})${RST}  \033[38;5;240m${DURATION_DISPLAY}${RST}${LINES_INFO} ${GIT_INFO}"
