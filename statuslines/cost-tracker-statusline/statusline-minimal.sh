#!/bin/zsh
# cost-tracker-statusline — Minimal Mono theme (muted tones, color only for alerts)
...
# Context warning + color — only warn states get color
CTX_WARN=""
...
echo -e "${CTX_COLOR}${MODEL} ${BAR} ${USED}%${RST}${CTX_WARN} \033[90m|\033[0m \033[90m\$${SESSION_COST_FMT} (\$${TOTAL_COST_FMT})\033[0m \033[90m|\033[0m \033[90m${DURATION_DISPLAY}${RST}${LINES_INFO} ${GIT_INFO}"
